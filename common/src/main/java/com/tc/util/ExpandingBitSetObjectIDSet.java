...
public class ExpandingBitSetObjectIDSet extends ObjectIDSet {
   ...
   */
  static final class BitSet extends AbstractTreeNode<BitSet> implements Comparable<BitSet>, TCSerializable<BitSet>, Iterable<Long>, Range {
    ...
    @Override
    public void swapPayload(Node<BitSet> other) {
