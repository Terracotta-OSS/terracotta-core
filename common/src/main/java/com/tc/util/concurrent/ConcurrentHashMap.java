...
/*
 * Repackaged for use in terracotta core by Chris Dennis. The only changes to this version where to override the
 * AbstractCollection toArray implementation in KeySet.toArray(), Values.toArray(), and EntrySet.toArray() to ensure
 * correct operation when using the 1.5 version of AbstractCollection. Also prePutCheck, postRemoveCheck, postClearCheck
 * added in Segment class. Segment class is also made non-final. "createSegment" method is added.
 */
