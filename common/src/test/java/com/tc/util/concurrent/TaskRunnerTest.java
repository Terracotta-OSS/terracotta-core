...
public class TaskRunnerTest {
  ...
  @Test
  public void testShouldNotLoseTaskResultOnInterrupt() throws InterruptedException {
  ...
  private static class TestTaskRunner extends ScheduledNamedTaskRunner {
    ...
    public TestTaskRunner(int corePoolSize) {
      super(corePoolSize);
    }

    public TestTaskRunner(int corePoolSize, ThreadFactory threadFactory) {
      super(corePoolSize, threadFactory);
    }

    public TestTaskRunner(int corePoolSize, RejectedExecutionHandler handler) {
      super(corePoolSize, handler);
    }

    public TestTaskRunner(int corePoolSize, ThreadFactory threadFactory, RejectedExecutionHandler handler) {
