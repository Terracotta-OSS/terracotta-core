...
public class BootJarSignatureTest extends TestCase {
  ...
  // patch level delimiter can be any character
  public void testVersionString() throws UnsupportedVMException {
    ...
    props = makeProps("Windows XP", "Sun Microsystems Inc.", "1.5.0.06", null, null);
