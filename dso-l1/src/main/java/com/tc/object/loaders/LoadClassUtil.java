...
public class LoadClassUtil {
  ...
  /**
   * The purpose of this method is to call loadClass on the relevant classloader but deal with possibility of class names like
   * "[Ljava.lang.String;" or "[[I" which are what you get from String[].class.getName() and int[][].class.getName(). Normally
   * Class.forName() just takes care of this for you but that method unfortunately caches results in an undesired way
   */
