 ...
 * <p/>
 * This statistic gives us the size of pending batches present in an L1 node. This value is sampled every second.
 */
public class SRAL1PendingBatchesSize implements StatisticRetrievalAction {
  ...
  public StatisticData[] retrieveStatisticData() {
    ...
    return new StatisticData[] { new StatisticData(ACTION_NAME, Long.valueOf(pendingBatches)) };
  }
