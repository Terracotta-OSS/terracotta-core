...
public class GCResultContext implements EventContext {
  ...
  private static final GarbageCollectionInfo          NULL_GARBAGE_COLLECTION_INFO           = new GarbageCollectionInfoImpl(-1);
  ...
  private GarbageCollectionInfo                       gcInfo                                 = NULL_GARBAGE_COLLECTION_INFO;
  private GarbageCollectionInfoPublisher              gcPublisher                            = NULL_GARBAGE_COLLECTION_INFO_PUBLISHER;
  ...
  public void setGcInfo(GarbageCollectionInfo gcInfo) {
    this.gcInfo = gcInfo;
  }

  public void setGcPublisher(GarbageCollectionInfoPublisher gcPublisher) {
