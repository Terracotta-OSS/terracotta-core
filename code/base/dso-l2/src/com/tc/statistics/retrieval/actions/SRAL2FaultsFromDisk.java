...
/**
 * This statistic gives the fault rate of objects faulted from disk to L2.
 * <p/>
 * The {@link StatisticData} contains the following elements:
 * <ul>
 * <li>fault count</li>
 * </ul>
 * <p/>
 * The {@link com.tc.statistics.retrieval.StatisticsRetriever} samples this data at the global frequency.
 * The property {@code l2.objectmanager.fault.logging.enabled} needs to be {@code true} to collect this statistic.
 */
