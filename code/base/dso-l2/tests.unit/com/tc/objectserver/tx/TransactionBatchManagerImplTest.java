...
public class TransactionBatchManagerImplTest extends TestCase {
  ...
  public void tests() throws Exception {
    ...
    // now calling batchComponentComplete on an undefined batch if the client has been killed should throw and exception
    for (int i = 1; i <= desc.count; i++) {
      try {
