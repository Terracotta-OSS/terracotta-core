 ...
 */
public class ObjectIDSet extends AbstractSet implements SortedSet, PrettyPrintable {

  private static final int MIN_JUMBO_SIZE = 20;
  ...
  public void clear() {
    if(this.internalSet instanceof TreeSet) {
      this.internalSet.clear();
    } else {
      //Reduce from jumbo to tiny
