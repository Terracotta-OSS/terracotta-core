 ...
 */
public final class Resin3xAppServerFactory extends AppServerFactory {

  // This class may only be instantiated by its parent which contains the ProtectedKey
  public Resin3xAppServerFactory(ProtectedKey protectedKey, TestConfigObject config) {
  ...
  public AppServer createAppServer(AppServerInstallation installation) {
    return new Resin3xAppServer((Resin3xAppServerInstallation) installation);
  }

  public AppServerInstallation createInstallation(File home, File workingDir) throws Exception {
    return new Resin3xAppServerInstallation(home, workingDir, config.appserverMajorVersion(), config
