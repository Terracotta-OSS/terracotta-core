...
public final class JBoss3xAppServerFactory extends AppServerFactory {
  ...
  public AppServerParameters createParameters(String instanceName, Properties props) {
    return new JBoss3xAppServerParameters(instanceName, props, config.sessionClasspath());
  }
  ...
  public AppServerInstallation createInstallation(URL host, File serverDir, File workingDir) throws Exception {
    return new JBoss3xAppServerInstallation(host, serverDir, workingDir, config.appserverMajorVersion(), config.appserverMinorVersion());
  }

  public AppServerInstallation createInstallation(File home, File workingDir) throws Exception {
    return new JBoss3xAppServerInstallation(home, workingDir, config.appserverMajorVersion(), config.appserverMinorVersion());
  }
  ...
  public StandardTerracottaAppServerConfig createTcConfig(File baseDir) {
    return new JBoss3xAppServerConfig(baseDir);
  }
}
