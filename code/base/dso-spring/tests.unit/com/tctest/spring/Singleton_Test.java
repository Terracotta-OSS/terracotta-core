  ...
  public static class SingletonApp extends AbstractTransparentApp {
    ...
    private void testSingletonWithParent() {
      try {
        ...
        ClassPathXmlApplicationContext ctx = new ClassPathXmlApplicationContext("com/tctest/spring/beanfactory-withParent.xml");
    ...
    public static void visitL1DSOConfig(ConfigVisitor visitor, DSOClientConfigHelper config) {
      config.addRoot("com.tctest.spring.Singleton_Test$SingletonApp", "sharedSingletons", "sharedSingletons", false);
