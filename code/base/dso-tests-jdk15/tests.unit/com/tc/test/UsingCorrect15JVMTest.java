 ...
 * </p><p>
 * This class should be in a tree declared as using the 1.5 JVM; it's here to make sure the 1.5 JVM is correct.
 */
public class UsingCorrect15JVMTest extends CorrectJVMTestBase {
