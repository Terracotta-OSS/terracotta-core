...
set JRUBY_HOME=%~dp0..\..\buildsystems\jruby-1.1
...
%JRUBY_HOME%\bin\jruby.bat -J-Djruby.thread.pooling=true -J-Xms64m -J-Xmx512m -Ibuildscripts buildscripts/build-tc.rb %*
