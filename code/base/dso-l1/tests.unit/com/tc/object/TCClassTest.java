...
public class TCClassTest extends BaseDSOTestCase {
  public void tests() throws Exception {
    ...
    final TCClass tcc2 = new TCClassImpl(fieldFactory, classFactory, objectManager, TestClass1.class, null,
                                         MockClassProvider.MOCK_LOADER, null, false, false, false, null, null, false,
                                         true, null, null);
    assertFalse(tcc2.isIndexed());
    assertTrue(tcc2.isNonStaticInner());
    final TCClass tcc3 = new TCClassImpl(fieldFactory, classFactory, objectManager, TestClass2.class, null,
                                         MockClassProvider.MOCK_LOADER, null, false, false, false, null, null, false,
                                         true, null, null);
    assertFalse(tcc3.isIndexed());
    assertFalse(tcc3.isNonStaticInner());
    final TCClass tcc4 = new TCClassImpl(fieldFactory, classFactory, objectManager, TestClass1[].class, null,
                                         MockClassProvider.MOCK_LOADER, null, true, false, false, null, null, false,
                                         true, null, null);
    assertTrue(tcc4.isIndexed());
    assertFalse(tcc4.isNonStaticInner());

    final LoaderDescription mockLoader2 = new LoaderDescription(null, "mock2");
    final TCClass tcc5 = new TCClassImpl(fieldFactory, classFactory, objectManager, TestClass1[].class, null,
                                         mockLoader2, null, true, false, false, null, null, false, true, null, null);
  ...
  public void testPortableFields() throws Exception {
    ...
    final TCClass tcc2 = new TCClassImpl(fieldFactory, classFactory, objectManager, TestSuperclass2.class, null,
                                         MockClassProvider.MOCK_LOADER, null, false, false, false, null, null, false,
                                         true, null, null);
    assertEquals(2, tcc2.getPortableFields().length);
    final TCClass tcc3 = new TCClassImpl(fieldFactory, classFactory, objectManager, TestClassPF.class, null,
                                         MockClassProvider.MOCK_LOADER, null, false, false, false, null, null, false,
                                         true, null, null);
