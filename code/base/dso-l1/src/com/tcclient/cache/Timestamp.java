...
/** 
 * Tracks timestamp information on when the idle and TTL timers 
...
public class Timestamp {
  ...
  private long timeToExpireMillis;    // Guarded by synchronized lock on "this"
  ...
  /**
   * Get the maximum time at which this timestamp can be valid, 
   * regardless of usage.
   */
  ...
  /**
   * Modify time at which this timestamp will expire due to idle.  
