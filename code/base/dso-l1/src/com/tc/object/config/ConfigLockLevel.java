...
public class ConfigLockLevel {
  ...
  public static final ConfigLockLevel CONCURRENT                   = new ConfigLockLevel(CONCURRENT_NAME,
  ...
  public static final ConfigLockLevel AUTO_SYNCHRONIZED_WRITE      = new ConfigLockLevel(AUTO_SYNCHRONIZED_WRITE_NAME,
                                                                                         LockLevel.WRITE);
  public static final ConfigLockLevel AUTO_SYNCHRONIZED_READ       = new ConfigLockLevel(AUTO_SYNCHRONIZED_READ_NAME,
                                                                                         LockLevel.READ);
