...
public class DSOUnsafeAdapter extends ClassAdapter implements Opcodes, ClassAdapterFactory {
  ...
  public void visitEnd() {
    ...
    mv = super.visitMethod(ACC_PUBLIC, "compareAndSwapObject", "(Ljava/lang/Object;JLjava/lang/Object;Ljava/lang/Object;)Z", null, null);
    addUnsafeWrapperMethodCode(mv, ACC_PUBLIC, "compareAndSwapObject", "(Ljava/lang/Object;JLjava/lang/Object;Ljava/lang/Object;)Z");
  ...
  private void addCheckedManagedConditionCode(MethodVisitor mv, Type[] params, int objParamIndex,
                                              Label nonSharedLabel, Label sharedLabel) {
    mv.visitVarInsn(params[objParamIndex].getOpcode(ILOAD), objParamIndex + 1);
    mv.visitMethodInsn(INVOKESTATIC, "com/tc/object/bytecode/ManagerUtil", "isManaged",
                       "(Ljava/lang/Object;)Z");
  ...
  private void addUnsafeWrapperMethodCode(MethodVisitor mv, int access, String methodName, String description) {
    ...
    mv.visitMethodInsn(INVOKESTATIC, "com/tc/util/UnsafeUtil", "updateDSOSharedField", "(Ljava/lang/Object;JLjava/lang/Object;)V");
