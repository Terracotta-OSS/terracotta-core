...
public class JavaUtilConcurrentHashMapAdapter extends ClassAdapter implements Opcodes {
  ...
  private void rewriteSizeMethod(MethodVisitor mv) {
    ...
    Label l1 = new Label();
    mv.visitLabel(l1);
    mv.visitLineNumber(693, l1);
    mv.visitInsn(LCONST_0);
    mv.visitVarInsn(LSTORE, 2);
    Label l2 = new Label();
    mv.visitLabel(l2);
    mv.visitLineNumber(694, l2);
    mv.visitInsn(LCONST_0);
    mv.visitVarInsn(LSTORE, 4);
    Label l3 = new Label();
    mv.visitLabel(l3);
    mv.visitLineNumber(695, l3);
    ...
    Label l7 = new Label();
    mv.visitLabel(l7);
    mv.visitLineNumber(699, l7);
    mv.visitInsn(LCONST_0);
    mv.visitVarInsn(LSTORE, 4);
    Label l8 = new Label();
    mv.visitLabel(l8);
    mv.visitLineNumber(700, l8);
    mv.visitInsn(LCONST_0);
    mv.visitVarInsn(LSTORE, 2);
    Label l9 = new Label();
    mv.visitLabel(l9);
    mv.visitLineNumber(701, l9);
    mv.visitInsn(ICONST_0);
    mv.visitVarInsn(ISTORE, 8);
    Label l10 = new Label();
    mv.visitLabel(l10);
    mv.visitLineNumber(702, l10);
    mv.visitInsn(ICONST_0);
    ...
    mv.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(I)Ljava/lang/StringBuilder;");
    mv.visitLdcInsn(", Segment i count: ");
    mv.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;");
    mv.visitVarInsn(ALOAD, 1);
    mv.visitVarInsn(ILOAD, 9);
    mv.visitInsn(AALOAD);
    ...
    Label l18 = new Label();
    mv.visitLabel(l18);
    mv.visitLineNumber(709, l18);
    mv.visitVarInsn(ILOAD, 8);
    Label l19 = new Label();
    mv.visitJumpInsn(IFEQ, l19);
    Label l20 = new Label();
    mv.visitLabel(l20);
    mv.visitLineNumber(710, l20);
    mv.visitInsn(ICONST_0);
    mv.visitVarInsn(ISTORE, 9);
    Label l21 = new Label();
    mv.visitLabel(l21);
    ...
    Label l26 = new Label();
    mv.visitLabel(l26);
    mv.visitLineNumber(713, l26);
    mv.visitLdcInsn(new Long(-1L));
    mv.visitVarInsn(LSTORE, 4);
    Label l27 = new Label();
    mv.visitLabel(l27);
    mv.visitLineNumber(714, l27);
    mv.visitJumpInsn(GOTO, l19);
    mv.visitLabel(l25);
    mv.visitLineNumber(710, l25);
    mv.visitIincInsn(9, 1);
    mv.visitLabel(l22);
    mv.visitVarInsn(ILOAD, 9);
    mv.visitVarInsn(ALOAD, 1);
    ...
    Label l29 = new Label();
    mv.visitLabel(l29);
    mv.visitLineNumber(719, l29);
    Label l30 = new Label();
    mv.visitJumpInsn(GOTO, l30);
    mv.visitLabel(l28);
    mv.visitLineNumber(698, l28);
    ...
    Label l32 = new Label();
    mv.visitLabel(l32);
    mv.visitLineNumber(722, l32);
    mv.visitInsn(LCONST_0);
    mv.visitVarInsn(LSTORE, 2);
    Label l33 = new Label();
    mv.visitLabel(l33);
    mv.visitLineNumber(723, l33);
    mv.visitInsn(ICONST_0);
    mv.visitVarInsn(ISTORE, 7);
    Label l34 = new Label();
    mv.visitLabel(l34);
    ...
    Label l42 = new Label();
    mv.visitLabel(l42);
    mv.visitLineNumber(727, l42);
    mv.visitFieldInsn(GETSTATIC, "com/tc/util/DebugUtil", "DEBUG", "Z");
    Label l43 = new Label();
    mv.visitJumpInsn(IFEQ, l43);
    Label l44 = new Label();
    mv.visitLabel(l44);
    mv.visitLineNumber(728, l44);
    mv.visitFieldInsn(GETSTATIC, "java/lang/System", "err", "Ljava/io/PrintStream;");
    mv.visitTypeInsn(NEW, "java/lang/StringBuilder");
    mv.visitInsn(DUP);
    mv.visitLdcInsn("Client id: ");
    ...
    Label l51 = new Label();
    mv.visitLabel(l51);
    mv.visitLineNumber(735, l51);
    mv.visitLdcInsn(new Integer(2147483647));
    mv.visitInsn(IRETURN);
    mv.visitLabel(l50);
    mv.visitLineNumber(737, l50);
    mv.visitVarInsn(LLOAD, 2);
    mv.visitInsn(L2I);
    mv.visitInsn(IRETURN);
    Label l52 = new Label();
    mv.visitLabel(l52);
    mv.visitLocalVariable("this", "Ljava/util/concurrent/ConcurrentHashMap;", "Ljava/util/concurrent/ConcurrentHashMap<TK;TV;>;", l0, l52, 0);
    mv.visitLocalVariable("segments", "[Ljava/util/concurrent/ConcurrentHashMap$Segment;", null, l1, l52, 1);
    mv.visitLocalVariable("sum", "J", null, l2, l52, 2);
    mv.visitLocalVariable("check", "J", null, l3, l52, 4);
    mv.visitLocalVariable("mc", "[I", null, l4, l52, 6);
    mv.visitLocalVariable("k", "I", null, l5, l30, 7);
    mv.visitLocalVariable("mcsum", "I", null, l10, l28, 8);
    mv.visitLocalVariable("i", "I", null, l11, l18, 9);
    mv.visitLocalVariable("i", "I", null, l21, l19, 9);
    mv.visitLocalVariable("i", "I", null, l34, l38, 7);
    mv.visitLocalVariable("i", "I", null, l39, l45, 7);
    mv.visitLocalVariable("i", "I", null, l46, l31, 7);
    mv.visitMaxs(5, 10);
    mv.visitEnd();
  }
  ...
  private void createTCDsoRequiredMethod() {
    ...
    Label l3 = new Label();
    mv.visitLabel(l3);
    mv.visitLineNumber(707, l3);
    mv.visitInsn(ICONST_0);
    mv.visitInsn(IRETURN);
    mv.visitLabel(l1);
    mv.visitLineNumber(709, l1);
  ...
  private void createTCForcedHashMethod() {
    ...
    mv.visitMethodInsn(INVOKESTATIC, "com/tc/object/bytecode/ManagerUtil", "getClientID", "()Ljava/lang/String;");
    mv.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;");
    mv.visitLdcInsn(", __tc_hash -- obj: ");
    mv.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;");
    mv.visitVarInsn(ILOAD, 3);
    mv.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(I)Ljava/lang/StringBuilder;");
    mv.visitLdcInsn(", useDsoHash: ");
    mv.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;");
    mv.visitVarInsn(ILOAD, 4);
    mv.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Z)Ljava/lang/StringBuilder;");
    mv.visitLdcInsn(", obj hashCode: ");
    mv.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;");
    mv.visitVarInsn(ALOAD, 1);
    mv.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Object", "hashCode", "()I");
    mv.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(I)Ljava/lang/StringBuilder;");
    mv.visitLdcInsn(", SystemIdentity: ");
    mv.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;");
    mv.visitVarInsn(ALOAD, 1);
    mv.visitMethodInsn(INVOKESTATIC, "java/lang/System", "identityHashCode", "(Ljava/lang/Object;)I");
    mv.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(I)Ljava/lang/StringBuilder;");
