...
public class HashtableMethodCreator implements MethodCreator, Opcodes {

  public void createMethods(ClassVisitor classVisitor) {
    MethodVisitor mv = classVisitor.visitMethod(ACC_PUBLIC, "getEntry",
                                              "(Ljava/lang/Object;)Ljava/util/Hashtable$Entry;", null, null);
    Label l0 = new Label();
    mv.visitLabel(l0);
