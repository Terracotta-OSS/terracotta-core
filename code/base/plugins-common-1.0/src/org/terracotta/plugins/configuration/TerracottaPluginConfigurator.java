 ...
 */
package org.terracotta.plugins.configuration;
...
public abstract class TerracottaPluginConfigurator implements BundleActivator {
  ...
  protected void registerPluginSpec(final BundleContext context) {
    // default empty body
  }
