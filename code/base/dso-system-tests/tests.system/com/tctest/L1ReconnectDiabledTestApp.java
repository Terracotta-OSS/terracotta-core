...
public class L1ReconnectDiabledTestApp extends AbstractTransparentApp {
  ...
  public L1ReconnectDiabledTestApp(String appId, ApplicationConfig cfg, ListenerProvider listenerProvider) {
    super(appId, cfg, listenerProvider);
    appCfg = cfg;
  }

  public static void visitL1DSOConfig(ConfigVisitor visitor, DSOClientConfigHelper config) {
    String testClass = L1ReconnectDiabledTestApp.class.getName();
