...
public class DefaultSessionIdTest extends TestCase {
  ...
  public final void testConstruction() {
    ...
    DefaultSessionId sid = new DefaultSessionId(id, null, id, Manager.LOCK_TYPE_WRITE);
    ...
    sid = new DefaultSessionId(id, id, id, Manager.LOCK_TYPE_WRITE);
    ...
    sid = new DefaultSessionId(id, id + id, id, Manager.LOCK_TYPE_WRITE);
