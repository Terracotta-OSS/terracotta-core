...
public final class CharChunk implements Cloneable, Serializable, CharSequence {
  ...
  public boolean equals(String s) {
    char[] c = buff;
    int len = end - start;
    if (c == null || len != s.length()) { return false; }
    int off = start;
    for (int i = 0; i < len; i++) {
      if (c[off++] != s.charAt(i)) { return false; }
    }
    return true;
  }
  ...
  public boolean equalsIgnoreCase(String s) {
    ...
    int off = start;
    for (int i = 0; i < len; i++) {
      if (Ascii.toLower(c[off++]) != Ascii.toLower(s.charAt(i))) { return false; }
    }
    return true;
  }
  ...
  public boolean equals(char b2[], int off2, int len2) {
    ...
    if (b1 == null || b2 == null || end - start != len2) { return false; }
    int off1 = start;
    int len = end - start;
    while (len-- > 0) {
  ...
  public boolean equals(byte b2[], int off2, int len2) {
    ...
    while (len-- > 0) {
      if (b1[off1++] != (char) b2[off2++]) { return false; }
    }
    return true;
  }
  ...
  public boolean startsWith(String s) {
    char[] c = buff;
    int len = s.length();
    if (c == null || len > end - start) { return false; }
    int off = start;
    for (int i = 0; i < len; i++) {
      if (c[off++] != s.charAt(i)) { return false; }
    }
  ...
  public boolean startsWithIgnoreCase(String s, int pos) {
    char[] c = buff;
    int len = s.length();
    if (c == null || len + pos > end - start) { return false; }
    int off = start + pos;
    for (int i = 0; i < len; i++) {
      if (Ascii.toLower(c[off++]) != Ascii.toLower(s.charAt(i))) { return false; }
    }
  ...
  public CharSequence subSequence(int s, int e) {
    try {
      ...
      result.setOffset(this.start + s);
      result.setEnd(this.start + e);
      return result;
