 ...
 */
package org.terracotta.plugins.iBatis_2_2_0;
...
public final class IBatisTerracottaConfigurator extends TerracottaPluginConfigurator {
  ...
  protected final void registerPluginSpec(final BundleContext context) {
    ...
    context.registerService(PluginSpec.class.getName(), new IBatisPluginSpec(new IBatisChangeApplicatorSpec(getClass().getClassLoader())), serviceProps);
  }
