...
public class SessionScopedBeanTest extends AbstractTwoServerDeploymentTest {
  ...
  private ISimpleBean         beanN1S1;                                                                                            // node1
                                                                                                                                    // session1
  private ISimpleBean         beanN1S2;                                                                                            // node1
                                                                                                                                    // session2

  private ISimpleBean         beanN2S1;                                                                                            // node2
                                                                                                                                    // session1
  private ISimpleBean         beanN2S2;                                                                                            // node2
                                                                                                                                    // session2
  ...
  private static class InnerTestSetup extends SpringTwoServerTestSetup {
    ...
    protected void configureWar(DeploymentBuilder builder) {
      ...
      builder.addRemoteService(HttpInvokerServiceExporter.class, SERVICE_FOR_SHARED_SESSION_SCOPED_BEAN, "simplebean",
                               ISimpleBean.class);
      // builder.addRemoteService(HttpInvokerServiceExporter.class,SERVICE_FOR_LOCAL_SESSION_SCOPED_BEAN,
      // "localsimplebean", ISimpleBean.class);
