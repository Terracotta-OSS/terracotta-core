...
public class BundleSpecTest extends TestCase {
  ...
  public void testValidateBundleSpec() {
    ...
    reqs = make("org.terracotta.modules.clustered-cglib-2.1.3;bundle-version:=3.0.0.SNAPSHOT");
    validate(reqs[0], true);
  }
  ...
  public void testGetRequirementsString() {
    ...
    reqs = check(1, "org.terracotta.modules.clustered-surefire-2.3;bundle-version:=3.0.0.SNAPSHOT");
    ...
    assertEquals("3.0.0.SNAPSHOT", reqs[0].getVersion());
    
    reqs = check(1, "org.terracotta.modules.excludes-config;bundle-version:=3.0.0.SNAPSHOT");
    assertEquals("org.terracotta.modules.excludes-config", reqs[0].getSymbolicName());
    assertEquals("org.terracotta.modules", reqs[0].getGroupId());
    assertEquals("excludes-config", reqs[0].getName());
    assertEquals("3.0.0.SNAPSHOT", reqs[0].getVersion());
    
    reqs = check(1, "org.terracotta.modules.clustered-cglib-2.1.3;bundle-version:=3.0.0.SNAPSHOT");
