...
/**
 * This class provides static helper methods to convert Maven identifiers to valid OSGi 
...
public class MavenToOSGi {
   ...
   * @param classifier Classifier string from Maven, this is expected to be parsed and not contain the leading dash, may be null
   */
  ...
  /**
   * Parse a Maven version string of the form  "digits(.digits(.digits))-classifier".  Maven 
