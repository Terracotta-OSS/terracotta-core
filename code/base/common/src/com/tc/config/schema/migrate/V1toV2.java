...
public class V1toV2 extends BaseConfigUpdate {
  ...
  public InputStream convert(InputStream in, XmlOptions xmlOptions) throws XmlException, IOException {
    XmlOptions options = new XmlOptions(xmlOptions); 
    options.setDocumentType(com.terracottatech.configV1.TcConfigDocument.type);
    ...
    if (v1Doc != null) {
      ...
      InputStream inStream = v1Doc.newInputStream(options);
