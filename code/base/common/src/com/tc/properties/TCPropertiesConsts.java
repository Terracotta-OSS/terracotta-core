...
public interface TCPropertiesConsts {
   ...
   * the L2 TODO : Explain all these parameters
   ********************************************************************************************************************/
   ...
   * maxObjectsToCommit                   - Max numberof Objects commited in one transaction in the commit stage and flush stage 
   ...
   * loadObjectID.fastLoad                - Enables/Disables fast loading of ObjectIDs. Only effective for persistence with mode permanent-store. This will speed up 
   ...
   * Description : This section contains the of Berkeley DB JE properties thats used in L2 For an explanation of these properties look at Berkeley DB documentation 
   * (l2.berkeleydb is removed before giving to Berkeley DB JE) 
   * je.lock.timeout = 3mins (in microsecs) since je throw Deadlock Exception on timeout
   ********************************************************************************************************************/
   ...
   * Description : This section contains the defaults for the JVM
   * compatibility for the L1 TODO : Explain all these parameters
   ********************************************************************************************************************/
   ...
   * Description : This section contains the defaults for the cache manager for
   * the L1 TODO : Explain all these parameters
   ********************************************************************************************************************/
  ...
  /*********************************************************************************************************************
   * Section : Common property for TC Management MBean Description : TC Management MBeans can be enabled/disabled
