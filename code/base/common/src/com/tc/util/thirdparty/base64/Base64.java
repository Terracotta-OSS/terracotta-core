/**
 * TERRACOTTA COMMENT: This source code is from http://iharder.net/base64. It's public domain, which means that you can
 * basically do anything at all with it, so I'm putting it here. &mdash; andrew, 2005-10-04.
 * </p>
 * <p>
 ...
 * @version 2.1
 */
package com.tc.util.thirdparty.base64;
        ...
        if (DECODABET[theByte & 0x7f] > WHITE_SPACE_ENC) {
          ...
          if (position >= bufferLength) // Enough to output.
          {
            ...
            position = 0;
                                                                                               ...
                                                                                               "Invalid character in Base64 data."); } // end
        // else:
        // not
        // white
        // space
