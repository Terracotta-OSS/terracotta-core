...
public class NonPortableEventContextFactory {
  ...
  /**
   * Create a context for when there is an attempt to access a shared object outside the scope of
   * a shared lock.
  ...
  /**
   * Create a context for when a transaction with read-only access is attempting
