...
public class BlockingCache124TestApp extends BlockingCacheTestApp {
  private CyclicBarrier barrier;
  private CacheManager  cacheManager;
  
  public BlockingCache124TestApp(String appId, ApplicationConfig cfg, ListenerProvider listenerProvider) {
  ...
  public static void visitL1DSOConfig(ConfigVisitor visitor, DSOClientConfigHelper config) {
    ...
    String testClass = BlockingCache124TestApp.class.getName();
