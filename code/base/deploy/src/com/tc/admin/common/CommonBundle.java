...
public class CommonBundle extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] { { "forums.url", "http://www.terracotta.org/kit/reflector?kitID={0}&pageID=Forums" },
        ...
        { "contact.support.title", "Contact Terracotta Technical Support" }, { "more", "More" }, { "less", "Less" },
        { "waiting", "Waiting..." }, { "canceled", "Canceled" }, { "cancel", "Cancel" }, { "delete", "Delete" },
        { "collected", "Collected" }, { "delete.all", "Delete All" }, { "ok", "OK" }, { "shutdown", "Shutdown" },
        { "details.link.text", "Details >>" }, { "back.link.text", "<< Back" }, { "connect.elipses", "Connect..." },
        { "status", "Status" }, { "disconnect", "Disconnect" }, { "connecting", "Connecting..." },
        { "failing.over", "Failing over..." }, { "enable", "enable" }, { "disable", "disable" },
        { "enabled", "Enabled" }, { "disabled", "Disabled" }, { "not.ready", "Not ready" },
        { "not.connected", "Not connected" }, { "next", "Next" }, { "previous", "Previous" }, { "refresh", "Refresh" },
