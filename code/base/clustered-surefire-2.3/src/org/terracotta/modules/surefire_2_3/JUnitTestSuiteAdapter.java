...
public class JUnitTestSuiteAdapter extends ClassAdapter implements ClassAdapterFactory, Opcodes {
  ...
  public MethodVisitor visitMethod(int access, String name, String desc, String signature, String[] exceptions) {
    ...
    addRunTest();
    addCreateBarrierAndWait();
    return null;
  }

  private void addRunTest() {
    MethodVisitor mv = cv.visitMethod(ACC_PUBLIC, "runTest", "(Ljunit/framework/Test;Ljunit/framework/TestResult;)V",
                                      null, null);
    mv.visitCode();
    Label l0 = new Label();
    mv.visitLabel(l0);
    mv.visitVarInsn(ALOAD, 1);
    mv.visitMethodInsn(INVOKESTATIC, "junit/framework/TestSuite", "createBarrierAndWait", "(Ljunit/framework/Test;)V");
    
    Label l1 = new Label();
    mv.visitLabel(l1);
    mv.visitVarInsn(ALOAD, 1);
    mv.visitVarInsn(ALOAD, 2);
    mv.visitMethodInsn(INVOKEINTERFACE, "junit/framework/Test", "run", "(Ljunit/framework/TestResult;)V");
    Label l2 = new Label();
    mv.visitLabel(l2);
    mv.visitInsn(RETURN);
    Label l3 = new Label();
    mv.visitLabel(l3);
    mv.visitLocalVariable("this", "Ljunit/framework/TestSuite;", null, l0, l3, 0);
    mv.visitLocalVariable("test", "Ljunit/framework/Test;", null, l0, l3, 1);
    mv.visitLocalVariable("result", "Ljunit/framework/TestResult;", null, l0, l3, 2);
    mv.visitMaxs(0, 0);
    mv.visitEnd();
  }
   ...
   *   try { 
   *     barrier = (CyclicBarrier) ManagerUtil.lookupOrCreateRoot("barrier:" + testName, new CyclicBarrier(numberOfNodes)); 
   *   } finally {
  ...
  private void addCreateBarrierAndWait() {
    MethodVisitor mv = cv.visitMethod(ACC_PRIVATE + ACC_STATIC, "createBarrierAndWait", "(Ljunit/framework/Test;)V", null, null);
    mv.visitCode();
    Label l0 = new Label();
    Label l1 = new Label();
    Label l2 = new Label();
    ...
    mv.visitMethodInsn(INVOKEVIRTUAL, "junit/framework/TestCase", "getName", "()Ljava/lang/String;");
    ...
    mv.visitInsn(DUP);
    mv.visitVarInsn(ILOAD, 1);
    mv.visitMethodInsn(INVOKESPECIAL, "EDU/oswego/cs/dl/util/concurrent/CyclicBarrier", "<init>", "(I)V");
    mv.visitMethodInsn(INVOKESTATIC, "com/tc/object/bytecode/ManagerUtil", "lookupOrCreateRoot", "(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;");
    mv.visitTypeInsn(CHECKCAST, "EDU/oswego/cs/dl/util/concurrent/CyclicBarrier");
    ...
    mv.visitMethodInsn(INVOKEVIRTUAL, "EDU/oswego/cs/dl/util/concurrent/CyclicBarrier", "barrier", "()I");
    mv.visitInsn(POP);
    mv.visitLabel(l7);
    Label l22 = new Label();
    ...
    mv.visitLocalVariable("globalLock", "Ljava/lang/String;", null, l16, l24, 3);
    mv.visitLocalVariable("barrier", "LEDU/oswego/cs/dl/util/concurrent/CyclicBarrier;", null, l17, l4, 4);
    mv.visitLocalVariable("barrier", "LEDU/oswego/cs/dl/util/concurrent/CyclicBarrier;", null, l6, l24, 4);
