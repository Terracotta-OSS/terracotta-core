...
public class RAMDirectoryTestApp extends AbstractErrorCatchingTransparentApp {
   ...
   */
  public RAMDirectoryTestApp(final String appId, final ApplicationConfig cfg, final ListenerProvider listenerProvider) {
   ...
   * @throws Throwable
   */
  private void addDataToMap(final String value) throws Throwable {
