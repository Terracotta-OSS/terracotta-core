...
/**
 * Adorns Java fields that are not to be included in a shared object graph.
 * 
...
public class TransientDecorator extends LabelProvider
  implements ILightweightLabelDecorator
{
  private static final ImageDescriptor
    m_imageDesc = ImageDescriptor.createFromURL(
      TransientDecorator.class.getResource(
        "/com/tc/admin/icons/transient_ovr.gif"));

  public static final String
    DECORATOR_ID = "org.terracotta.dso.transientDecorator";
