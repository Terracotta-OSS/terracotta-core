...
public class AdaptedModuleDecorator extends LabelProvider
  implements ILightweightLabelDecorator
{
  ...
  public static final String
    DECORATOR_ID = "org.terracotta.dso.adaptedModuleDecorator";
  ...
  public void decorate(Object element, IDecoration decoration) {
    ...
    if(plugin.hasTerracottaNature(project)) {
      ...
      if(config != null && 
         (config.isAdaptable(cu) ||
          TcPlugin.getDefault().isBootClass(cu)))
      {
