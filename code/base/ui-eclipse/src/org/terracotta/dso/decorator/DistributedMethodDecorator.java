...
/**
 * Adorns Java methods that are invoked on all instances within a shared root hierarchy. The adornment appears in the
 * Package Explorer amd Outline view.
 * 
 * @see org.eclipse.jface.viewers.LabelProvider
 * @see org.terracotta.dso.ConfigurationHelper.isDistributed
 */

public class DistributedMethodDecorator extends LabelProvider implements ILightweightLabelDecorator {
  private static final ImageDescriptor m_imageDesc  = ImageDescriptor.createFromURL(DistributedMethodDecorator.class
                                                        .getResource("/com/tc/admin/icons/owned_ovr.gif"));

  public static final String           DECORATOR_ID = "org.terracotta.dso.distributedMethodDecorator";
