...
/**
 * Adorns Java modules whose primary type is excluded from instrumentation.
 * 
...
public class ExcludedModuleDecorator extends LabelProvider
  implements ILightweightLabelDecorator
{
  private static final ImageDescriptor
    m_imageDesc = ImageDescriptor.createFromURL(
      ExcludedModuleDecorator.class.getResource(
        "/com/tc/admin/icons/error_co.gif"));

  public static final String
    DECORATOR_ID = "org.terracotta.dso.excludedModuleDecorator";
