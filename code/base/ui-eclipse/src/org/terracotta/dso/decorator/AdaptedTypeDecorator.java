...
public class AdaptedTypeDecorator extends LabelProvider
  implements ILightweightLabelDecorator
{
  private static final ImageDescriptor
  m_imageDesc = ImageDescriptor.createFromURL(
    AdaptedTypeDecorator.class.getResource(
      "/com/tc/admin/icons/installed_ovr.gif"));

  public static final String
    DECORATOR_ID = "org.terracotta.dso.adaptedTypeDecorator";
  ...
  public void decorate(Object element, IDecoration decoration) {
    ...
    if(plugin.hasTerracottaNature(project)) {
      ...
      if(config != null && 
         (config.isAdaptable(type) ||
          TcPlugin.getDefault().isBootClass(type)))
      {
