...
/**
 * Adorns Java methods that are name-locked.
 * 
...
public class NameLockedDecorator extends LabelProvider
  implements ILightweightLabelDecorator
{
  private static final ImageDescriptor
    m_imageDesc = ImageDescriptor.createFromURL(
      NameLockedDecorator.class.getResource(
        "/com/tc/admin/icons/namelocked_ovr.gif"));

  public static final String
    DECORATOR_ID = "org.terracotta.dso.nameLockedDecorator";
