...
set JAVA_OPTS=%JAVA_OPTS% -DSTOP.PORT=8282
set JAVA_OPTS=%JAVA_OPTS% -DSTOP.KEY=secret
start "terracotta for spring: jmx sample: 8082" %TC_HOME%\bin\dso-java.bat %JAVA_OPTS% -jar %JETTY_HOME%\start.jar jetty-conf.xml
endlocal
