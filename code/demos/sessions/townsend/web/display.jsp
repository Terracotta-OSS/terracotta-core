...
msgDsoFullCart  =   'This web application is currently running clustered on Terracotta Sessions, and you have viewed a camera.<br><br>You can click the above link to jump over to the other server.&nbsp;  Since the session data is being shared across servers, the recent products list will be preserved.<br><br>If you just jumped over from the other server, the recent products list has been maintained because Terracotta Sessions replicated the session data.&nbsp;  You have achieved high-availability scale-out.&nbsp;  Now you can use Terracotta Sessions Configurator for a live view of the Java objects (cart items) in the session data.&nbsp;  Click on the <i><b>Monitor</b></i> tab, connect to the server, expand <i><b>DSO</b></i> and <i><b>Roots</b></i>, and then drill down to the session data and its objects.';
function getMsg() {
