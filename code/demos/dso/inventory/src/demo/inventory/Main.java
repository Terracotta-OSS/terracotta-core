...
public class Main 
{
   ...
   private void printInventory() 
   {
      ...
      out.println();
      printProductHeader();
      for(Iterator i = store.inventory.values().iterator(); i.hasNext(); ) 
      {
   ...
   private void printDepartments() 
   {
      ...
      out.println("+----------------------------------+");
      out.println();
      for(Iterator i = store.departments.iterator(); i.hasNext(); ) 
      {
   ...
   {
      out.print(padString(p.sku,8));
      out.print(padString(p.name,20));
      out.print(padString(p.price+"",8));
      out.println();
   }
   ...
   private void updatePrice() 
   {
      ...
      do 
      {
         out.println("Enter new price for '"+p.name+"': ");
         out.print("> ");
         out.flush();
         String s = getInput().toUpperCase();
         try 
