...
start call "%topdir%\libexec\tc-functions.bat" tc_java %tc_java_opts% -cp "classes;lib\org.mortbay.jetty-4.2.20.jar;lib\javax.servlet.jar" demo.sharedqueue.Main %*
endlocal
