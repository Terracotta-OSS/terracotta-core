...
public class Main
{
   ...
   private static String text1 = 
      "Application started; I expect a total of @TOKEN@ VMs that will be participating.\n"               + 
   ...
   private static String text3 =
      "All of the participating VMs have completed their task.\n" +
      "I am stopping now.";
   ...
   /**
    * Create an instance, setting the number of VMs expected to 
   ...
   public Main(int expectedParticipants) 
   {
      ...
      if (expectedParticipants < MINIMUM_EXPECTED_PARTICIPANTS) 
      {
         ...
         System.out.println("(You did not pass an argument, I'm assuming " + expectedParticipants + " VMs will be participating)\n");
      }
      ...
      throws Exception 
   {
      ...
      try { expectedParticipants = Integer.parseInt(args[0]); }
      catch (Exception e) { }
