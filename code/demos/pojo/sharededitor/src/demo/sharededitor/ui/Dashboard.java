   ...
   extends JToolBar
{
	...
	public Dashboard(Dispatcher dispatcher)
	{
	   ...
	   final String IMAGE_BEDROOM      = "/images/bedroom.gif";
		...
		dispatcher.setTexture(new ImageIcon(getResource(IMAGE_BEDROOM)).getImage());
	   ...
	   implements IFillStyleConsts
	{
		   ...
		   extends javax.swing.filechooser.FileFilter
		{
		   ...
		   { 
		      return f.getName().endsWith(".jpeg") || f.getName().endsWith(".jpg") || f.getName().endsWith(".gif") || f.getName().endsWith(".png");
		   }
