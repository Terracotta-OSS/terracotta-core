...
CALL "%TOPDIR%\bin\tc-functions.bat" tc_java_opts -server -Xms256m -Xmx256m -Xss128k -Dcom.sun.management.jmxremote "-Dtc.install-root=%TC_INSTALL_DIR%" -Dcom.sun.jmx.trace.level=TRACE
