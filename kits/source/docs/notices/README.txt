Terracotta 3.6.0-SNAPSHOT - Simple Scale for Enterprise Java
===================================================
...
http://www.terracotta.org/kit/reflector?kitID=3.5.0&pageID=ReleaseNotes

Help and additional information is available on the web at the following URLs:

 - Product Documentation: 
    http://www.terracotta.org/kit/reflector?kitID=3.5.0&pageID=ProductDocumentation 
