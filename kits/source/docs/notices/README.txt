Terracotta 3.5.0-SNAPSHOT - Simple Scale for Enterprise Java
===================================================
...
http://www.terracotta.org/kit/reflector?kitID=3.4.0&pageID=Documentation
...
Sign up at http://www.terracotta.org/kit/reflector?kitID=3.4.0&pageID=Register


Resources
---------
The latest release notes are available on the web at 
http://www.terracotta.org/kit/reflector?kitID=3.4.0&pageID=ReleaseNotes
...
examples and information:
 ...
 - bin: Scripts for administering, monitoring, and maintaining a Terracotta
   ...
   (http://www.terracotta.org/kit/reflector?kitID=3.4.0&pageID=ToolsOverview)
 
Help and additional information is available on the web at the following URLs:

 - Product Documentation: 
    http://www.terracotta.org/kit/reflector?kitID=3.4.0&pageID=ProductDocumentation 
 - Forums:        http://forums.terracotta.org
 - Mailing Lists: http://lists.terracotta.org
 - Services:      
    http://www.terracotta.org/kit/reflector?kitID=3.4.0&pageID=SupportServices
