...
/**
 * A Log based implementation of {@link StateDumper}, key-value mappings will be logged using {@link Logger}
 *
 * @author vmad
 */
class LogBasedStateDumper implements StateDumper {

  private static final Logger LOGGER = LoggerFactory.getLogger("LogBasedStateDumper");
