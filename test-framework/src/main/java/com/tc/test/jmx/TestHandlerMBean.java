...
public interface TestHandlerMBean {
	 ...
	 * 
	 * @param groupIndex
	 *            : the index of the mirror group for which the active needs to
	 *            be crashed
	 * @throws Exception
	 */
	 ...
	 * 
	 * @param groupIndex
	 *            the group index in which the server is to be crashed
	 * @param serverIndex
	 *            the last crashed server index in the mirror group
	 * @throws Exception
	 */
	public void restartCrashedServer(int groupIndex, int serverIndex)
			throws Exception;
	 ...
	 * 
	 * @param groupIndex
	 *            the index of the mirror group in which the server is to be
	 *            restarted
	 * @throws Exception
	 */
	public void reastartLastCrashedServer(final int groupIndex)
			throws Exception;
	...
	/**
	 * Crashes the active and waits till passive becomes active in a specified
	 * mirror group
	 * 
	 * @param groupIndex
	 * @throws Exception
	 */
	public void crashActiveAndWaitForPassiveToTakeOver(int groupIndex)
			throws Exception;

	/**
	 * returns the tc url <br>
	 * e.g if there are two mirror groups having two servers in each this will
	 * return
