...
public interface OperatorEventsServiceV2 {
   ...
   */
  Collection<OperatorEventEntityV2> getOperatorEvents(Set<String> serverNames, String sinceWhen, String eventTypes, boolean filterOutRead) throws ServiceExecutionException;
