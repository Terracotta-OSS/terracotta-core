...
public enum TCMessageType {
    ...
    LIST_REGISTERED_SERVICES_MESSAGE(true),
    LIST_REGISTERED_SERVICES_RESPONSE_MESSAGE(true),
    INVOKE_REGISTERED_SERVICE_MESSAGE(true),
    INVOKE_REGISTERED_SERVICE_RESPONSE_MESSAGE(true),
