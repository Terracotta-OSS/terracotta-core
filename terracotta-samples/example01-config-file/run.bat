...
%JAVA_HOME%\bin\java.exe  -cp %BIGMEMORY_CP% -Xmx200m  -Dcom.tc.productkey.path="%BIGMEMORY%"/terracotta-license.key   com.bigmemory.samples.configfile.ConfigFileBasedBigMemoryConfiguration
