...
public class L1ReconnectDisabledTestApp extends AbstractTransparentApp {
  ...
  public L1ReconnectDisabledTestApp(String appId, ApplicationConfig cfg, ListenerProvider listenerProvider) {
    super(appId, cfg, listenerProvider);
    appCfg = cfg;
  }

  public static void visitL1DSOConfig(ConfigVisitor visitor, DSOClientConfigHelper config) {
    String testClass = L1ReconnectDisabledTestApp.class.getName();
  ...
  private void testL1ReconnectConfig() throws ConfigurationSetupException {
    ...
    try {
      ...
      Assert.assertEquals(L1ReconnectDisabledTest.L1_RECONNECT_TIMEOUT, l1ReconnectConfig.getReconnectTimeout());
    } catch (Exception e) {
      throw new AssertionError(e);
    }
  }
