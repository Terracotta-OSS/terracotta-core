 ...
 */
public class ExpirationInterestMessageImpl extends DSOMessageBase implements ExpirationInterestMessage {
  ...
  public ExpirationInterestMessageImpl(final SessionID sessionID, final MessageMonitor monitor,
