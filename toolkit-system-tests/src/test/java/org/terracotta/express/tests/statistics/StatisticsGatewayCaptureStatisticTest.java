...
public class StatisticsGatewayCaptureStatisticTest extends AbstractStatisticsTestBase {
  public StatisticsGatewayCaptureStatisticTest(TestConfig testConfig) {
    super(testConfig);
  }

  @Override
  protected void duringRunningCluster() throws Exception {
    int total_node_count = StatisticsGatewayTestClient.NODE_COUNT + 1;
