...
public class StatisticsGathererTest extends AbstractStatisticsTestBase implements StatisticsGathererListener {
  public StatisticsGathererTest(TestConfig testConfig) {
    super(testConfig);
  }
  ...
  protected void duringRunningCluster() throws Exception {
    ...
    gatherer.connect("localhost", jmxPort);
    assertEquals("localhost:" + jmxPort, listenerConnected);
    ...
    do {
      ...
      got_all_shutdowns = (number_of_shutdowns == StatisticsGatewayTestClient.NODE_COUNT + 1);
