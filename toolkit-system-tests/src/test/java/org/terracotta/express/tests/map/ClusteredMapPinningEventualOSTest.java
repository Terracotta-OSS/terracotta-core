...
public class ClusteredMapPinningEventualOSTest extends AbstractToolkitTestBase {
  private static final int NODE_COUNT = 8;

  public ClusteredMapPinningEventualOSTest(TestConfig testConfig) {
    super(testConfig);
    testConfig.getClientConfig().setClientClasses(PinningTestClient.class, NODE_COUNT);
    testConfig.getClientConfig()
        .addExtraClientJvmArg("-D" + PinningTestClient.CONSISTENCY + "=" + Consistency.EVENTUAL);
  }
