...
public class ClusteredMapMaxElementsOnDiskEventualTest extends AbstractToolkitTestBase {

  public ClusteredMapMaxElementsOnDiskEventualTest(TestConfig testConfig) {
    super(testConfig, Client.class);
    testConfig.getCrashConfig().setServerCrashWaitTimeInSec(50);
