...
public class L1ReconnectEnabledTest extends AbstractToolkitTestBase {

  public L1ReconnectEnabledTest(TestConfig testConfig) {
    super(testConfig, App.class);
    testConfig.getL2Config().addExtraServerJvmArg("-Dcom.tc." + TCPropertiesConsts.L2_L1RECONNECT_ENABLED + "=true");
  ...
  public static class App extends ClientBase {
    private static final int L1_RECONNECT_TIMEOUT = 1234;
    ...
    protected void test(Toolkit toolkit) throws Throwable {
      ...
      Assert.assertTrue(l1ReconnectPropFromL2.getL1ReconnectEnabled());
