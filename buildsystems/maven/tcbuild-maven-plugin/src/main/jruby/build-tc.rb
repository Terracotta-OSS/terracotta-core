...
# Formerly AutoRequire'd - sorry, too much voodoo for me -- eredmond
require 'buildscripts/additions'
require 'buildscripts/archive_tag'
require 'buildscripts/boot_jars'
require 'buildscripts/builder_base'
require 'buildscripts/build_environment'
require 'buildscripts/build_results'
require 'config-sources'
require 'buildscripts/cross_platform'
require 'buildscripts/constants'
require 'buildscripts/distribution_results'
require 'buildscripts/eclipse'
...
require 'buildscripts/terracotta_home'
require 'buildscripts/test_set'
require 'buildscripts/testrun_record'
require 'buildscripts/testrun_results'
