...
class BaseCodeTerracottaBuilder <  TerracottaBuilder
  ...
  require 'buildscripts/extensions/distribution-utils'
  include DistributionUtils
  
  require 'buildscripts/extensions/bundled-components'
  include BundledComponents

  require 'buildscripts/extensions/bundled-vendors'
  include BundledVendors
  
  require 'buildscripts/extensions/bundled-demos'
  include BundledDemos

  require 'buildscripts/extensions/bundled-modules'
  include BundledModules

  require 'buildscripts/extensions/bundled-jres'
  include BundledJREs

  require 'buildscripts/extensions/packaging'
  include Packaging

  require 'buildscripts/extensions/postscripts'
  include Postscripts
