...
# XXX: hack... externalize this a bit
#        out = nil
#        if descrip =~ /1.4/
#          root = File.expand_path( $java_home_14.absolute_path )
#          out = JVM.new(root, { :minimum_version => '1.4.2_09', :maximum_version => '1.4.999_999' })
#        elsif descrip =~ /1.5/
#          root = File.expand_path( $java_home_15.absolute_path )
#          out = JVM.new(root, { :minimum_version => '1.5.0_0', :maximum_version => '1.6.999_999' })
#        end
#
#        unless out.nil?
