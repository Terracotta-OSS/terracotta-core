...
<ROOT>
	<ELEMENT_ITER>
		...
		RULES={
			{'*','#DOCUMENT/xs:schema[getAttrStringValue("targetNamespace") == getStringParam("nsURI")]/descendant::xs:simpleType'};
		}
		SORTING='by-attr'
...
CHECKSUM='GYFYV497ssCkCOABHlHDlg'
</DOCFLEX_TEMPLATE>