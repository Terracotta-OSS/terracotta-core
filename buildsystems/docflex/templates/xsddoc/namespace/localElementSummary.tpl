...
<ROOT>
	<ELEMENT_ITER>
		...
		RULES={
			{'*','#DOCUMENT/xs:schema[getAttrStringValue("targetNamespace") == getStringParam("nsURI")]/descendant::xs:%localElement'};
		}
		FILTER='getAttrValue("ref") == ""'
...
CHECKSUM='GSSUrMKKTDFCM1el38zCpQ'
</DOCFLEX_TEMPLATE>