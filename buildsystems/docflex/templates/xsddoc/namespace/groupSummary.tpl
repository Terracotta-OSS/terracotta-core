...
<ROOT>
	<ELEMENT_ITER>
		...
		RULES={
			{'*','#DOCUMENT/xs:schema[getAttrStringValue("targetNamespace") == getStringParam("nsURI")]/descendant::xs:group'};
		}
		SORTING='by-attr'
...
<STOCK_SECTIONS>
	<FOLDER>
		...
		<BODY>
			...
			<TEMPLATE_CALL>
				COND='! getBooleanParam("fmt.allowNestedTables")'
				TEMPLATE_FILE='../groups/groupProfile2.tpl'
				PASSED_PARAMS={
					'showNS','false';
				}
				OUTPUT_TYPE='included'
...
CHECKSUM='qURuUiKniCY6URvs5u1?vw'
</DOCFLEX_TEMPLATE>