...
<ROOT>
	<ELEMENT_ITER>
		...
		RULES={
			{'*','#DOCUMENT/xs:schema[getAttrStringValue("targetNamespace") == getStringParam("nsURI")]/descendant::xs:complexType'};
		}
		SORTING='by-attr'
...
<STOCK_SECTIONS>
	<FOLDER>
		...
		<BODY>
			...
			<TEMPLATE_CALL>
				COND='! getBooleanParam("fmt.allowNestedTables")'
				TEMPLATE_FILE='../type/typeProfile2.tpl'
				PASSED_PARAMS={
					'showNS','false';
				}
				OUTPUT_TYPE='included'
...
CHECKSUM='EOuv3kvzkQbGAl6JgloxAA'
</DOCFLEX_TEMPLATE>