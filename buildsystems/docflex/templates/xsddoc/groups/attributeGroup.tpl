...
<TEMPLATE_PARAMS>
	...
	PARAM={
		param.name='qName';
		param.description='The <code>QName</code> object representing the attributeGroup qualified name.\n<p>\nSee Expr. Assistant | XML Functions | Namespace / QName | <code>QName()</code> function.';
		param.type='object';
...
<ROOT>
	...
	<TEMPLATE_CALL>
		...
		COND='getBooleanParam("doc.attributeGroup.profile")'
	...
	<TEMPLATE_CALL>
		...
		COND='getBooleanParam("doc.attributeGroup.xmlRep")'
		FMT={
	...
	<FOLDER>
		...
		COND='getBooleanParam("doc.attributeGroup.list.usage") &&\ngetIntParam("usageCount") > 0'
		FMT={
			...
			<FOLDER>
				...
				<BODY>
					<ELEMENT_ITER>
						...
						SCOPE='custom'
						ELEMENT_ENUM_EXPR='findElementsByKey ("attributeGroup-usage", getParam("qName"))'
						SORTING='by-expr'
	...
	<FOLDER>
		DESCR='Annotation'
		COND='getBooleanParam("doc.attributeGroup.annotation")'
		COLLAPSED
		<BODY>
			<TEMPLATE_CALL>
				FMT={
	...
	<FOLDER>
		DESCR='XML SOURCE'
		COND='getBooleanParam("doc.attributeGroup.xmlSource")'
		<HTARGET>
			TARGET_KEYS={
				'contextElement.id';
				'"xml-source"';
	...
	<TEMPLATE_CALL>
		...
		COND='getBooleanParam("doc.attributeGroup.attributes")'
...
CHECKSUM='HF9tjzFVt8tddWWSLFRYzQ'
</DOCFLEX_TEMPLATE>