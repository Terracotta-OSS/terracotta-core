...
public class SRAL2ServerMapGetSizeRequestsRateTest extends TestCase {
  ...
  public void testRetrieval() {
    SRAL2ServerMapGetSizeRequestsRate sral2TransactionCount = new SRAL2ServerMapGetSizeRequestsRate(
    ...
    Assert.assertEquals(SRAL2ServerMapGetSizeRequestsRate.ACTION_NAME, statisticDatas[0].getName());
