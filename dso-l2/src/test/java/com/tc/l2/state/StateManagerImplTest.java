...
public class StateManagerImplTest {
  ...
  public void setUp() throws Exception {
    ...
    for(int i = 0; i < NUM_OF_SERVERS; i++) {
      ...
      StateManagerConfig stateManagerConfigMock = mock(StateManagerConfig.class);
      ...
      stateManagers[i] = new StateManagerImpl(tcLogger, groupManagers[i], stageChangeSinkMock, stageManagers[i], stateManagerConfigMock, weightGeneratorFactory,
