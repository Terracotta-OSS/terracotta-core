...
public class ConcurrentDistributedServerMapManagedObjectStateTest extends TCTestCase {
  ...
  public void testCapacityEvictionWhenOverLimit() throws Exception {
    ...
    state.applyLogicalAction(oid, applyTransactionInfo, LogicalOperation.PUT, new Object[] { "a", oid });
  ...
  public void testL2SyncDehyrdate() throws Exception {
    ...
    verify(dnaWriter).addLogicalAction(LogicalOperation.PUT, new Object[] { "key1", value1.getObjectID(), value1.getCreationTime(),
        value1.getLastAccessedTime(), value1.getTimeToIdle(), value1.getTimeToLive() });
    verify(dnaWriter).addLogicalAction(LogicalOperation.PUT, new Object[] { "key2", value2.getObjectID(), value2.getCreationTime(),
  ...
  public void testL1FaultDehydrate() throws Exception {
    ...
    verify(dnaWriter, times(10)).addPhysicalAction(anyString(), any());
    verify(dnaWriter, never()).addLogicalAction(any(LogicalOperation.class), any(Object[].class));
  }

  public void testPut() throws Exception {
    Object key = "key";
    CDSMValue value = new CDSMValue(new ObjectID(2), 0, 0, 0, 0);
    state.applyLogicalAction(oid, applyTransactionInfo, LogicalOperation.PUT, new Object[] { key, value.getObjectID() });
  ...
  public void testRemove() throws Exception {
    Object key = "key";
    state.applyLogicalAction(oid, applyTransactionInfo, LogicalOperation.REMOVE, new Object[] { key });
    verify(applyTransactionInfo, never()).deleteObject(any(ObjectID.class));
    verify(applyTransactionInfo, never()).invalidate(any(ObjectID.class), any(ObjectID.class));
  ...
  public void testRemoveIfEqual() throws Exception {
    ...
    state.applyLogicalAction(oid, applyTransactionInfo, LogicalOperation.REMOVE_IF_VALUE_EQUAL, new Object[] { key, new ObjectID(2) });
    ...
    state.applyLogicalAction(oid, applyTransactionInfo, LogicalOperation.REMOVE_IF_VALUE_EQUAL, new Object[] { key, valueOid });
  ...
  public void testReplaceIfEqual() throws Exception {
    ...
    state.applyLogicalAction(oid, applyTransactionInfo, LogicalOperation.REPLACE_IF_VALUE_EQUAL, new Object[] { key, new ObjectID(3), value
        .getObjectID() });
    ...
    state.applyLogicalAction(oid, applyTransactionInfo, LogicalOperation.REPLACE_IF_VALUE_EQUAL, new Object[] { key, new ObjectID(1), value
        .getObjectID() });
    value.setVersion(1L);
    verify(keyValueStorage).put(key, value);
  ...
  public void testPutIfAbsent() throws Exception {
    ...
    when(keyValueStorage.containsKey(key)).thenReturn(true);
    state.applyLogicalAction(oid, applyTransactionInfo, LogicalOperation.PUT_IF_ABSENT, new Object[] { key, value.getObjectID() });
    verify(keyValueStorage, never()).put(key, value);
    verify(applyTransactionInfo).deleteObject(value.getObjectID());
    verify(applyTransactionInfo).invalidate(oid, value.getObjectID());
  ...
  public void testPutIfAbsentVersioned() throws Exception {
    ...
    when(keyValueStorage.get(key)).thenReturn(oldValue);
    state.applyLogicalAction(oid, applyTransactionInfo, LogicalOperation.PUT_IF_ABSENT_VERSIONED, new Object[] {
    ...
    state.applyLogicalAction(oid, applyTransactionInfo, LogicalOperation.PUT_IF_ABSENT_VERSIONED, new Object[] { key,
  ...
  public void testClearVersioned() throws Exception {
    ...
    state.applyLogicalAction(oid, applyTransactionInfo, LogicalOperation.CLEAR_VERSIONED, ArrayUtils.EMPTY_OBJECT_ARRAY);
  ...
  public void testMustDeleteObjectsOnClearAndSendEvents() throws Exception {
    ...
    state.applyLogicalAction(oid, applyTransactionInfo, LogicalOperation.CLEAR, ArrayUtils.EMPTY_OBJECT_ARRAY);
  ...
  public void testSetLastAccessedTime() throws Exception {
    Object key = "key";
    CDSMValue value = new CDSMValue(new ObjectID(1), 0, 0, 0, 0);
    state.applyLogicalAction(oid, applyTransactionInfo, LogicalOperation.SET_LAST_ACCESSED_TIME, new Object[] { key, value
        .getObjectID(), 42L });
    verify(keyValueStorage, never()).put(key, value);
  ...
  public void testPutWithExpiry() throws Exception {
    Object key = "key";
    ObjectID valueOid = new ObjectID(1);
    state.applyLogicalAction(oid, applyTransactionInfo, LogicalOperation.PUT, new Object[] { key, valueOid, 1L, 2L, 3L, 4L });
  ...
  public void testPutIfAbsentWithExpiry() throws Exception {
    Object key = "key";
    ObjectID valueOid = new ObjectID(1);
    state.applyLogicalAction(oid, applyTransactionInfo, LogicalOperation.PUT_IF_ABSENT, new Object[] { key, valueOid, 1L, 2L, 3L, 4L });
    verify(keyValueStorage).put(key, new CDSMValue(valueOid, 1L, 2L, 3L, 4L));
  }
  ...
  public void testReplaceIfEqualWithExpiry() throws Exception {
    ...
    when(keyValueStorage.get(key)).thenReturn(new CDSMValue(new ObjectID(1), 0, 0, 0, 0));
    state.applyLogicalAction(oid, applyTransactionInfo, LogicalOperation.REPLACE_IF_VALUE_EQUAL, new Object[] { key,
  ...
  public void testShouldSendOperationCountChangeEventOnEachPut() throws Exception {
    ...
    assertEquals(150, listener.count);
  }
  ...
  public void testEvictionEvent() throws Exception {
    ...
    state.applyLogicalAction(oid, applyTransactionInfo, LogicalOperation.REMOVE_IF_VALUE_EQUAL, new Object[] { key, valueID });
  ...
  private TestDNACursor createOperationRateDNACursor() {
    ...
    for (int i = 0; i < 50; i++) {
      cursor.addLogicalAction(LogicalOperation.PUT, new Object[] { "key-" + (1000 + i), new ObjectID(1000 + i) });
    }
    for (int i = 0; i < 50; i++) {
      cursor.addLogicalAction(LogicalOperation.PUT_IF_ABSENT, new Object[] { "key-" + (2000 + i), new ObjectID(2000 + i) });
    }
    for (int i = 0; i < 50; i++) {
      cursor.addLogicalAction(LogicalOperation.REMOVE, new Object[] { "key-" + (1000 + i) });
    }
  ...
  public void testRegisterServerEventListener() throws Exception {
    ...
    state.applyLogicalAction(oid, searchableApplyInfoForNode(client11),
                             LogicalOperation.REGISTER_SERVER_EVENT_LISTENER,
  ...
  public void testUnregisterServerEventListener() throws Exception {
    ...
    state.applyLogicalAction(oid, searchableApplyInfoForNode(client11),
                             LogicalOperation.UNREGISTER_SERVER_EVENT_LISTENER,
                             new Object[] { ServerEventType.PUT_LOCAL.ordinal() });
  ...
  public void testRelayedRegisterServerEventListener() throws Exception {
    ...
    state.applyLogicalAction(oid, searchableApplyInfoForNode(new ServerID()),
                             LogicalOperation.REGISTER_SERVER_EVENT_LISTENER_PASSIVE,
  ...
  public void testRemoveEventListeningClient() throws Exception {
    ...
    state.applyLogicalAction(oid, searchableApplyInfoForNode(client11),
                             LogicalOperation.REMOVE_EVENT_LISTENING_CLIENT, new Object[] { 11L });
