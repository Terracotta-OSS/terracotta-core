...
public class ModificationToInterestFunctionTest {
  ...
  public void testShouldTransformModificationToTypedInterests() {
    ...
    modifications.add(new Modification(ModificationType.PUT, 1, new ObjectID(101), new byte[] {11}));
    modifications.add(new Modification(ModificationType.REMOVE, 2, new ObjectID(102)));
    modifications.add(new Modification(ModificationType.EVICT, 3, new ObjectID(103)));
