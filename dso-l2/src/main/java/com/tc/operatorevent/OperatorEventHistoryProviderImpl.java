...
public class OperatorEventHistoryProviderImpl implements TerracottaOperatorEventHistoryProvider {
  ...
  public OperatorEventHistoryProviderImpl() {
    operatorEventHistory = new CircularLossyQueue<>(TCPropertiesImpl.getProperties()
