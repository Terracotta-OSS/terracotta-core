...
public class RemoteJMXProcessor implements Sink<CallbackExecuteContext> {
  ...
  @Override
  public void addSingleThreaded(CallbackExecuteContext callbackContext) {
    try {
      int retries = 0;
      while (true) {
        try {
  ...
  @Override
  public void addMultiThreaded(CallbackExecuteContext context) {
