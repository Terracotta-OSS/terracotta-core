...
public abstract class AbstractResourceBundleFactory extends AbstractFactory implements ResourceBundleFactory {
  ...
  private static String FACTORY_SERVICE_ID = "com.tc.product.ResourceBundleFactory";
  private static Class<StandardResourceBundleFactory> STANDARD_BUNDLE_FACTORY_CLASS = StandardResourceBundleFactory.class;
