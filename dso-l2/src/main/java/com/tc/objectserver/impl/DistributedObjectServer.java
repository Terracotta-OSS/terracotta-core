...
// setup replication    
    ...
    final Stage<ReplicationIntent> replicationSenderStage = stageManager.createStage(ServerConfigurationContext.ACTIVE_TO_PASSIVE_DRIVER_STAGE, ReplicationIntent.class, replicationSender, 1, maxStageSize);
