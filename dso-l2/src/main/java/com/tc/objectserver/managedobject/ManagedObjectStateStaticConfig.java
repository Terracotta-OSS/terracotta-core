...
public enum ManagedObjectStateStaticConfig {
  ...
  public static enum Factory {
    TOOLKIT_TYPE_ROOT_TYPE_FACTORY() {
      ...
      @Override
      public ManagedObjectState readFrom(ObjectInput objectInput, GBPersistentObjectFactory objectFactory) throws IOException {
      ...
      public ManagedObjectState newInstance(ObjectID oid, long classId,
                                            GBPersistentObjectFactory objectFactory) {
    ...
    MAP_TYPE_FACTORY() {
      ...
      @Override
      public ManagedObjectState readFrom(ObjectInput objectInput, GBPersistentObjectFactory objectFactory) throws IOException, ClassNotFoundException {
    ...
    public abstract ManagedObjectState readFrom(ObjectInput objectInput, GBPersistentObjectFactory objectFactory) throws IOException, ClassNotFoundException;
