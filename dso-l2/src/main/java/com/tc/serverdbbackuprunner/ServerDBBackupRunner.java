...
public class ServerDBBackupRunner {
  ...
  public static MBeanServerConnection getMBeanServerConnection(JMXConnector jmxConnector, String host, int port) {
  ...
  public static void removeListenerAndCloseJMX(NotificationListener listener, JMXConnector jmxConnector,
                                               MBeanServerConnection mbs) {
