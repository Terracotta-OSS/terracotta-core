...
--------
   ...
   server            Directory containing libraries, executables, and other supporting files for Terracotta Server
   ...
   code-samples      Directory containing code samples for BigMemory Max
...
------------
   ...
   Additional information is available on the FAQ page at http://www.terracotta.org/documentation/bigmemorymax/technical-faq
