...
public class RelaySender {
  ...
  private static final int MAXIMUMBATCHSIZE = Integer.MAX_VALUE;
  private static final int IDEALMESSAGESINFLIGHT = 1;
  ...
  public RelaySender(GroupManager<AbstractGroupMessage> groupManager, Predicate<GroupMessage> msgCheck, Sink<Runnable> sentToActive) {
