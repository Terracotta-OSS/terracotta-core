...
public class ProcessTransactionHandlerTest {
  ...
  public void setUp() throws Exception {
    ...
    entityManager = new EntityManagerImpl(this.terracottaServiceProviderRegistry, clientEntityStateManager, eventCollector, processor, this::sendNoop, new ServiceLocator(this.getClass().getClassLoader(), false), MetricService.NOOP);
